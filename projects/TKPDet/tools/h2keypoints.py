# https://github.com/vansin/mmrotate/blob/backup/data.py
...
def read_ann(ann_path):
    ...
    txt_list = os.listdir(ann_path)

    for txt in txt_list:
        with open(ann_path+txt, 'r') as f:
            lines = f.readlines()
...
if __name__ == '__main__':
    ...
    ann_path = 'data/TRR360D/ann_train_hbbox/'
    img_path = 'data/TRR360D/img_train_hbbox/'


    result = read_ann(ann_path)
